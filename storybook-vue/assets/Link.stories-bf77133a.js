...
})`,...(p=r.parameters)==null?void 0:p.storySource}};var g;a.parameters={...a.parameters,storySource:{source:`createStory(meta, {
  name: 'E-mail link',
  args: {
    textContent: 'Email',
    href: 'mailto:info@example.com'
  }
})`,...(g=a.parameters)==null?void 0:g.storySource}};var h;i.parameters={...i.parameters,storySource:{source:`createStory(meta, {
  name: 'Telephone link',
  args: {
...
})`,...(x=d.parameters)==null?void 0:x.storySource}};var y;c.parameters={...c.parameters,storySource:{source:`createStory(meta, {
  name: 'Focus visible',
  args: {
...
})`,...(y=c.parameters)==null?void 0:y.storySource}};var w;u.parameters={...u.parameters,storySource:{source:`createStory(meta, {
  name: 'Active',
  args: {
...
})`,...(w=u.parameters)==null?void 0:w.storySource}};var j;m.parameters={...m.parameters,storySource:{source:`createStory(meta, {
  name: 'Visited',
  args: {
...
})`,...(j=m.parameters)==null?void 0:j.storySource}};const Z=["Default","ExternalLink","EmailLink","TelephoneLink","AlternateLanguageLink","CurrentLanguageLink","Hover","Focus","FocusVisible","Active","Visited"];export{u as Active,o as AlternateLanguageLink,s as CurrentLanguageLink,t as Default,a as EmailLink,r as ExternalLink,d as Focus,c as FocusVisible,l as Hover,i as TelephoneLink,m as Visited,Z as __namedExportsOrder,n as default};
//# sourceMappingURL=Link.stories-bf77133a.js.map
