...
`,u={document:{"background-color":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}},type:"color"},color:{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}},type:"color"},"font-family":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"*",inherits:!0}},type:"fontFamilies"},"font-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}},type:"fontSizes"},"font-weight":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}},type:"fontWeights"},"line-height":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}},type:"lineHeights"}}},l={utrecht:u},p={id:"vue-document",title:"Vue.js Component/Document",component:t,tags:["autodocs"],argTypes:{},args:{},render:()=>({components:{Document:t,Heading:r,Paragraph:s},template:'<Document v-bind="$props"><slot></slot></Document>'}),parameters:{status:{type:"ALPHA"},tokens:l,tokenPrefix:"utrecht-document",docs:{component:{description:m}}}},e=a(p,{name:"Document",args:{slot:`<Heading :level="1">Lorem ipsum</Heading><Paragraph>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
  magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
  consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
  pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
  laborum.</Paragraph>`}});var o,n,i;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`createStory(meta, {
  name: 'Document',
  args: {
...
})`,...(i=(n=e.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};const W=["Default"];export{e as Default,W as __namedExportsOrder,p as default};
//# sourceMappingURL=Document.stories-e4916557.js.map
