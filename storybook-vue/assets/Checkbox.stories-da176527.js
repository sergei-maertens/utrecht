...
`,V={checkbox:{}},I={utrecht:V},a={id:"vue-checkbox",title:"Vue.js Component/Checkbox",component:c,tags:["autodocs"],argTypes:{checked:{name:"checked",type:{name:"boolean",required:!1},table:{defaultValue:{summary:!1}}},disabled:{name:"disabled",type:{name:"boolean",required:!1},table:{defaultValue:{summary:!1}}},invalid:{name:"invalid",type:{name:"boolean",required:!1},table:{defaultValue:{summary:!1}}},required:{name:"required",type:{name:"boolean",required:!1},table:{defaultValue:{summary:!1}}},modelValue:{name:"modelValue",type:{name:"string",required:!1},table:{defaultValue:{summary:""}}},value:{name:"value",type:{name:"string",required:!1},table:{defaultValue:{summary:""}}}},args:{},render:()=>({components:{Checkbox:c},template:'<Checkbox v-bind="$props" @update:modelValue="updateModelValue"></Checkbox>',methods:{updateModelValue:C("updateModelValue")}}),parameters:{status:{type:"ALPHA"},tokens:I,tokenPrefix:"utrecht-checkbox",docs:{description:{component:A}}}},t=e(a,{name:"Checkbox",args:{checked:!0,name:"example-checkbox",value:"optional value"}}),n=e(a,{name:"Checked",args:{modelValue:"true",name:"example-checkbox",value:"optional value"}}),o=e(a,{name:"Disabled",args:{disabled:!0,name:"example-checkbox",value:"optional value"}}),r=e(a,{name:"Disabled and checked",args:{disabled:!0,modelValue:"true",name:"example-checkbox",value:"optional value"}}),s=e(a,{name:"Invalid",args:{invalid:!0,name:"example-checkbox",value:"optional value"}});var i,l,u;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`createStory(meta, {
  name: 'Checkbox',
  args: {
    checked: true,
...
})`,...(u=(l=t.parameters)==null?void 0:l.docs)==null?void 0:u.source}}};var d,m,h;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`createStory(meta, {
  name: 'Checked',
  args: {
    modelValue: 'true',
    name: 'example-checkbox',
...
})`,...(h=(m=n.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};var p,b,k;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`createStory(meta, {
  name: 'Disabled',
  args: {
    disabled: true,
    name: 'example-checkbox',
...
})`,...(k=(b=o.parameters)==null?void 0:b.docs)==null?void 0:k.source}}};var x,f,g;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`createStory(meta, {
...
})`,...(g=(f=r.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var y,v,w;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`createStory(meta, {
  name: 'Invalid',
  args: {
    invalid: true,
    name: 'example-checkbox',
...
})`,...(w=(v=s.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};const $=["Default","Checked","Disabled","DisabledChecked","Invalid"];export{n as Checked,t as Default,o as Disabled,r as DisabledChecked,s as Invalid,$ as __namedExportsOrder,a as default};
//# sourceMappingURL=Checkbox.stories-da176527.js.map
