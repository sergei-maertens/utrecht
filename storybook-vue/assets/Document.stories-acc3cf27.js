...
`,a={document:{"background-color":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}}},color:{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}}},"font-family":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"*",inherits:!0}}},"font-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"font-weight":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"line-height":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}}}},m={utrecht:a},u={id:"vue-document",title:"Vue.js Component/Document",component:t,tags:["autodocs"],argTypes:{},args:{},render:()=>({components:{Document:t,Heading:o,Paragraph:i},template:'<Document v-bind="$props"><slot></slot></Document>'}),parameters:{status:{type:"ALPHA"},tokens:m,tokenPrefix:"utrecht-document",docs:{component:{description:s}}}},e=r(u,{name:"Document",args:{slot:`<Heading :level="1">Lorem ipsum</Heading><Paragraph>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
  magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
  consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
  pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
  laborum.</Paragraph>`}});var n;e.parameters={...e.parameters,storySource:{source:`createStory(meta, {
  name: 'Document',
  args: {
...
})`,...(n=e.parameters)==null?void 0:n.storySource}};const L=["Default"];export{e as Default,L as __namedExportsOrder,u as default};
//# sourceMappingURL=Document.stories-acc3cf27.js.map
