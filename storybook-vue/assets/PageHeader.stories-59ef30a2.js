...
`,d={"page-header":{"background-color":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}}},color:{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}}},"padding-start":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"padding-block-end":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}}}},p={utrecht:d},m={id:"vue-page-header",title:"Vue.js Component/Page header",component:n,tags:["autodocs"],argTypes:{},args:{},render:()=>({components:{PageHeader:n,Paragraph:o},template:'<PageHeader v-bind="$props"><slot></slot></PageHeader>'}),parameters:{status:{type:"ALPHA"},tokens:p,tokenPrefix:"utrecht-page-header",docs:{component:{description:s}}}},e=i(m,{name:"Page header",args:{template:"Logo en navigatie kunnen hier"}});var t,a,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`createStory(meta, {
  name: 'Page header',
  args: {
    template: \`Logo en navigatie kunnen hier\`
  }
})`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const W=["Default"];export{e as Default,W as __namedExportsOrder,m as default};
//# sourceMappingURL=PageHeader.stories-59ef30a2.js.map
