...
`,i={"page-header":{"background-color":{css:{syntax:"<color>",inherits:!0}},color:{css:{syntax:"<color>",inherits:!0}},"padding-start":{css:{syntax:"<length>",inherits:!0}},"padding-block-end":{css:{syntax:"<length>",inherits:!0}}}},s={utrecht:i},d={id:"vue-page-header",title:"Vue.js Component/Page header",component:t,tags:["autodocs"],argTypes:{},args:{},render:()=>({components:{PageHeader:t,Paragraph:n},template:'<PageHeader v-bind="$props"><slot></slot></PageHeader>'}),parameters:{status:{type:"ALPHA"},tokens:s,tokenPrefix:"utrecht-page-header",docs:{component:{description:o}}}},e=r(d,{name:"Page header",args:{template:"Logo en navigatie kunnen hier"}});var a;e.parameters={...e.parameters,storySource:{source:`createStory(meta, {
  name: 'Page header',
  args: {
    template: \`Logo en navigatie kunnen hier\`
  }
})`,...(a=e.parameters)==null?void 0:a.storySource}};const L=["Default"];export{e as Default,L as __namedExportsOrder,d as default};
//# sourceMappingURL=PageHeader.stories-f48941aa.js.map
