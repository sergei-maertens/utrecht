...
export const UtrechtBadgeDataLetterSpacing : string;
export const UtrechtBadgeDataTextTransform : string;
export const UtrechtBadgeStatusLetterSpacing : string;
export const UtrechtBadgeStatusTextTransform : string;
export const UtrechtBadgeBackgroundColor : string; // Default background color for badge components
export const UtrechtBadgeBorderRadius : string; // Default corner radius for badge components
export const UtrechtBadgeColor : string; // Default text color for badge components
export const UtrechtBadgePaddingBlock : string; // Default block padding for badge components
export const UtrechtBadgePaddingInline : string; // Default inline padding color for badge components
export const UtrechtBlockquoteMarginInlineStart : string;
export const UtrechtBlockquoteMarginInlineEnd : string;
export const UtrechtBlockquoteMarginInlineBlockStart : string;
export const UtrechtBlockquoteMarginInlineBlockEnd : string;
...
export const UtrechtBreadcrumbBlockSize : string;
...
export const UtrechtBreadcrumbLinkBackgroundColor : string;
export const UtrechtBreadcrumbLinkColor : string;
export const UtrechtBreadcrumbDividerInlineSize : string;
...
export const UtrechtFormInputFontFamily : string;
export const UtrechtFormInputFontSize : string;
export const UtrechtFormInputMaxInlineSize : string;
...
export const UtrechtHeading5LetterSpacing : string;
export const UtrechtHeading5TextTransform : string;
...
export const UtrechtLogoMaxHeight : string;
export const UtrechtLogoMaxWidth : string;
...
export const UtrechtMapcontrolbuttonFocusBoxShadowColor : string;
export const UtrechtMapcontrolbuttonFocusBorderStyle : string;
export const UtrechtMapcontrolbuttonFocusTextDecoration : string;
export const UtrechtMapcontrolbuttonFocusOutlineColor : string;
...
export const UtrechtSpaceBlockSm : string; // Small
export const UtrechtSpaceBlockMd : string; // Medium
export const UtrechtSpaceBlockLg : string; // Large
export const UtrechtSpaceBlockXl : string; // Extra Large
export const UtrechtSpaceBlock2xl : string; // Extra Large 2
export const UtrechtSpaceBlock3xl : string; // Extra Large 3
export const UtrechtSpaceBlock4xl : string; // Extra Large 4
export const UtrechtSpaceBlock5xl : string; // Extra Large 5
export const UtrechtSpaceInline3xs : string; // Extra Small 3
export const UtrechtSpaceInline2xs : string; // Extra Small 2
export const UtrechtSpaceInlineXs : string; // Extra Small
export const UtrechtSpaceInlineSm : string; // Small
export const UtrechtSpaceInlineMd : string; // Medium
export const UtrechtSpaceInlineLg : string; // Large
export const UtrechtSpaceInlineXl : string; // Extra Large
export const UtrechtSpaceInline2xl : string; // Extra Large 2
export const UtrechtSpaceInline3xl : string; // Extra Large 3
export const UtrechtSpaceText3xs : string; // Extra Small 3
export const UtrechtSpaceText2xs : string; // Extra Small 2
export const UtrechtSpaceTextXs : string; // Extra Small
export const UtrechtSpaceTextSm : string; // Small
export const UtrechtSpaceTextMd : string; // Medium
export const UtrechtSpaceTextLg : string; // Large
export const UtrechtSpaceTextXl : string; // Extra Large
export const UtrechtSpaceText2xl : string; // Extra Large 2
export const UtrechtSpaceText3xl : string; // Extra Large 3
export const UtrechtSpaceRow4xs : string; // Extra Small 4
export const UtrechtSpaceRow3xs : string; // Extra Small 3
export const UtrechtSpaceRow2xs : string; // Extra Small 2
export const UtrechtSpaceRowXs : string; // Extra Small
export const UtrechtSpaceRowSm : string; // Small
export const UtrechtSpaceRowMd : string; // Medium
export const UtrechtSpaceRowLg : string; // Large
export const UtrechtSpaceRowXl : string; // Extra Large
export const UtrechtSpaceRow2xl : string; // Extra Large 2
export const UtrechtSpaceRow3xl : string; // Extra Large 3
export const UtrechtSpaceRow4xl : string; // Extra Large 4
export const UtrechtSpaceRow5xl : string; // Extra Large 5
export const UtrechtSpaceColumn4xs : string; // Extra Small 4
export const UtrechtSpaceColumn3xs : string; // Extra Small 3
export const UtrechtSpaceColumn2xs : string; // Extra Small 2
export const UtrechtSpaceColumnXs : string; // Extra Small
export const UtrechtSpaceColumnSm : string; // Small
export const UtrechtSpaceColumnMd : string; // Medium
export const UtrechtSpaceColumnLg : string; // Large
export const UtrechtSpaceColumnXl : string; // Extra Large
export const UtrechtSpaceColumn2xl : string; // Extra Large 2
...
export const UtrechtColorRed20 : string; // donker rood
...
export const UtrechtColorYellow80 : string; // spotlight en uitgelicht
export const UtrechtColorGreen40 : string; // donker groen
...
export const UtrechtTypographyScale2xsFontSize : string; // 8px
