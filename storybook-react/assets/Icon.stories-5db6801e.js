import{j as n}from"./jsx-runtime-670450c2.js";import{M as s}from"./index-8b643457.js";import{t as l,d as u}from"./util-cccc7565.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./clsx.m-ace26a20.js";import"./extends-98964cd2.js";import"./index-4d501b15.js";const d=`<!-- @license CC0-1.0 -->
...
`,m={icon:{color:{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<color>",inherits:!0}}},size:{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length-percentage>",inherits:!0}}},"inset-block-start":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},baseline:{"inset-block-start":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}}}}},h={utrecht:m},p={title:"React Component/Icon",id:"react-icon",component:s,parameters:{tokensPrefix:"utrecht-icon",tokens:l,tokensDefinition:h,docs:{description:{component:d}}}},g=({color:i,size:c,...a})=>n("div",{style:{"--utrecht-icon-color":i,"--utrecht-icon-size":`${c}px`},children:n(s,{...a})}),e=g.bind({});e.args={children:n("svg",{viewBox:"0 0 1000 1000",children:n("rect",{fill:"currentColor",x:"0",y:"0",width:"1000",height:"1000"})}),color:"green",size:32};const t=u(p);var o;e.parameters={...e.parameters,storySource:{source:`({
  color,
  size,
  ...args
}) => <div style={{
...
//# sourceMappingURL=Icon.stories-5db6801e.js.map
