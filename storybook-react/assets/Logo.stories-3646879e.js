import{j as g}from"./jsx-runtime-29545a09.js";import{t as p,d as k}from"./util-066ffab3.js";import{c as u}from"./clsx.m-1229b3e0.js";import{r as b}from"./index-76fb7be0.js";import{L as v}from"./LogoImage-8ad5c27e.js";import"./index-8d47fad6.js";import"./_commonjsHelpers-de833af9.js";const t=b.forwardRef(({children:o,className:m,...h},c)=>g("div",{ref:c,className:u("utrecht-logo",m),...h,children:o}));t.displayName="Logo";try{t.displayName="Logo",t.__docgenInfo={description:"",displayName:"Logo",props:{}}}catch{}const j=`<!-- @license CC0-1.0 -->
...
`,w={logo:{"max-block-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"max-inline-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"min-block-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}},"min-inline-size":{$extensions:{"nl.nldesignsystem.css.property":{syntax:"<length>",inherits:!0}}}}},f={utrecht:w},x={title:"React Component/Logo",id:"react-logo",component:t,args:{},parameters:{status:{type:"WORK IN PROGRESS"},tokensPrefix:"utrecht-logo",tokens:p,tokensDefinition:f,docs:{description:{component:j}}}},e={args:{children:g(v,{})}},n=k(x);var i,a,r;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    children: <LogoImage />
  }
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var s,l,d;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:"designTokenStory(meta)",...(d=(l=n.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};const _=["Default","DesignTokens"];export{e as Default,n as DesignTokens,_ as __namedExportsOrder,x as default};
//# sourceMappingURL=Logo.stories-3646879e.js.map
