import{j as p}from"./jsx-runtime-29545a09.js";import{c as b}from"./clsx.m-1229b3e0.js";import{r as v}from"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";const t=v.forwardRef(({children:r,className:u,value:a,...g},c)=>p("data",{value:typeof a=="string"||typeof a=="number"?String(a):void 0,...g,ref:c,className:b("utrecht-number-data",u),children:r}));t.displayName="NumberData";try{t.displayName="NumberData",t.__docgenInfo={description:"",displayName:"NumberData",props:{value:{defaultValue:null,description:"",name:"value",required:!1,type:{name:"string | number"}}}}}catch{}const f=`<!-- @license CC0-1.0 -->
...
//# sourceMappingURL=NumberData.stories-1360657f.js.map
