import{r as b,c,h as e,g as h}from"./index-e61b4b29-72cd9023.js";import{c as i}from"./clsx.m-9f200cc0-1229b3e0.js";import"./preload-helper-41c905a7.js";const d=`.utrecht-button{--_utrecht-button-background-color:var(
  ...
  );--_utrecht-button-hint-disabled-border-color:var(--utrecht-button-subtle-warning-disabled-border-color);--_utrecht-button-hint-disabled-color:var(--utrecht-button-subtle-warning-disabled-color);--_utrecht-button-hint-focus-background-color:var(--utrecht-button-subtle-warning-focus-background-color);--_utrecht-button-hint-focus-border-color:var(--utrecht-button-subtle-warning-focus-border-color);--_utrecht-button-hint-focus-color:var(--utrecht-button-subtle-warning-focus-color);--_utrecht-button-hint-hover-background-color:var(--utrecht-button-subtle-warning-hover-background-color);--_utrecht-button-hint-hover-border-color:var(--utrecht-button-subtle-warning-hover-border-color);--_utrecht-button-hint-hover-color:var(--utrecht-button-subtle-warning-hover-color)}:host{display:inline-block}:host([hidden]){display:none !important}`,l=class{constructor(o){b(this,o),this.utrechtRequestReset=c(this,"utrechtRequestReset",7),this.utrechtRequestSubmit=c(this,"utrechtRequestSubmit",7),this.appearance=void 0,this.busy=void 0,this.disabled=void 0,this.type=void 0}render(){const o=()=>{var t,r;this.utrechtRequestReset.emit().defaultPrevented||(r=(t=this.host)===null||t===void 0?void 0:t.closest("form"))===null||r===void 0||r.reset()},n=()=>{var t,r;this.utrechtRequestSubmit.emit().defaultPrevented||(r=(t=this.host)===null||t===void 0?void 0:t.closest("form"))===null||r===void 0||r.requestSubmit()},u=()=>{this.type==="reset"?o():this.type==="submit"&&n()};return e("button",{class:i("utrecht-button",this.busy&&"utrecht-button--busy",this.disabled&&"utrecht-button--disabled",this.type==="submit"&&"utrecht-button--submit",this.appearance==="primary-action-button"&&"utrecht-button--primary-action",this.appearance==="secondary-action-button"&&"utrecht-button--secondary-action",this.appearance==="subtle-button"&&"utrecht-button--subtle"),"aria-busy":this.busy?"true":null,disabled:this.disabled,type:this.type||"button",onClick:u},e("slot",null))}get host(){return h(this)}};l.style=d;export{l as utrecht_button};
//# sourceMappingURL=utrecht-button.entry-64a1de51.js.map
